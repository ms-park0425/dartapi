...
| 2512 | 2025년 사업보고서 | 1,044 | 18 | 51 | 1,113 | **94%** |
| 2603 | 2026년 1분기 | — | — | — | — | **미검증** |
| 2606 | 2026년 반기 | — | — | — | — | **미검증** |

> 2503~2512는 `parse_annual.py` + `ir_fill.py` 적용 후 최종 수치 (2026-08-25 기준). 2312·2412는 DART 기준.

> **2603·2606**: 정답 데이터 없어 정확도 미검증. DART 최신 재다운로드(2026-09-01) + FISIS 실시간 + IR 팩트시트 적용 완료. 2603: 73개 컬럼·812개 값, 2606: 69개 컬럼·761개 값 (12개 회사). `2026_동업사 공시비교_DATA_작업_260901.xlsx`에 반영.
...
- **2603 (미검증)**: 2026년 1분기. DART 재다운로드(2026-09-01) 570셀 + IR fill 55개 값 = 812개 값 (12개 회사). 예실차 Col111-117 7–8개사 커버.
- **2606 (미검증)**: 2026년 반기. DART 재다운로드(2026-09-01) 496셀 + IR fill 78개 값 = 761개 값 (12개 회사). 2026년 신규 XBRL 구조(eHYA·eHYQ 분리, 전기말CSM 5-dim) 대응.
...
| 107 | 손해율(누계) | **IR 팩트시트** | ✅ 10/12 (삼성화재·메리츠 MISS) |
| 108 | 위험보험료 | **IR 팩트시트** | ✅ 11/12 |
| 109 | 사고보험금 | **IR 팩트시트** | ✅ 11/12 |
| 111 | 예실차 합계 | **IR 팩트시트** | ✅ 11/12 |
| 112~117 | 예실차 세부 | **IR 팩트시트** | ✅ 10/12 |

> **XBRL/FISIS에는 없음** — IR 팩트시트에서만 추출 가능. 삼성화재·메리츠화재는 팩트시트 시트 구조상 일부 MISS. 팩트시트 없는 기간은 MISS.
...
| Col | 항목 | 소스 | 결과 |
|-----|------|------|------|
| 146~150 | BEL+RA기준 (해지율·위험률·사업비·기타·물량) | XBRL → **IR 팩트시트** | ⚠️ 동양·삼성화재 MISS (2/12), 한화 Col149 부호반전 FAIL |
| 151 | BEL+RA기준 기타 | XBRL → **IR 팩트시트** | ⚠️ 신한라이프·동양·삼성화재 MISS (3/12) |
| 153~158 | CSM기준 (해지율~손실요소) | XBRL → **IR 팩트시트** | ⚠️ 동양·삼성화재 MISS (2/12), 삼성생명 Col156 MISS |
...
| 회사 | OK | FAIL | OK율 | 채우는 컬럼 |
|---|---:|---:|---:|---|
| 미래에셋생명 | 89 | 7 | 92.7% | 22·25–30·75–80·99·107–109·111–117 |
| 삼성화재 | 42 | 0 | 100% | 25·73–80·92–97·99·112·115 |
| 한화생명 | 40 | 0 | 100% | 21·75–80·111·112·115 |
| 삼성생명 | 38 | 2 | 95.0% | 75–80·107–109·111 |
| 동양생명 | 27 | 0 | 100% | 75–80·92–94 |
| 메리츠화재 | 24 | 0 | 100% | 75–80 |
| 현대해상 | 23 | 0 | 100% | 13·18·21–23·55·63·65·71·99·111–117 |
| **합계** | **283** | **9** | **96.9%** | |
