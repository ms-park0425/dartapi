...
> OK=1,043 / FAIL=19 / MISS=51 (OK율 94%)
...
| 107 | 손해율(누계) | **IR 팩트시트** | 각 사 팩트시트 손해율 행 | ✅ 10/12 (삼성화재·메리츠 MISS) |
| 108 | 위험보험료 | **IR 팩트시트** | 팩트시트 위험보험료 행 | ✅ ~11/12 |
| 109 | 사고보험금 | **IR 팩트시트** | 팩트시트 사고보험금 행 | ✅ ~11/12 |
| 111 | 예실차 합계 | **IR 팩트시트** | 팩트시트 예실차 합계 행 | ✅ ~11/12 |
| 112~117 | 예실차 세부 | **IR 팩트시트** | 팩트시트 예실차 세부 행 | ✅ ~10/12 |
